...
import { Task, TaskDialogResult } from 'src/app/core/interface/task-item/task-item';
...
export class KanbanComponent implements OnInit, OnDestroy {
  ...
  constructor(private navService: NavService, private dialog: MatDialog, private kanbanService: KanbanService) {
